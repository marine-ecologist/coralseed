...
Cesium.GeoJsonDataSource.load("geojson/lizard_seascape.geojson").then(seascapes => {
  ...
  // 2. Larval tracks
  return Cesium.GeoJsonDataSource.load("geojson/Llines.geojson", { clampToGround: true }).then(paths => {
  ...
  // 3. Settlers
  return Cesium.GeoJsonDataSource.load("geojson/Lpoints.geojson", { clampToGround: true }).then(settlers => {
