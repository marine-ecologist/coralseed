---
title: "Examples: i) Clam Garden, Lizard Island"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Examples: i) Clam Garden, Lizard Island}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---


Example `coralseed` scenario from Clam Garden, a lagoonal site at Lizard Island (nGBR), December 2022. The model simulates a point source release of 1000 particles from a 5\*5m area within the site across a 6.95hrs period.

```{r mapoutput, fig.width=8, fig.height=10, fig.align = 'center', warning=FALSE, message=FALSE}
...
particles <- seed_particles(input="example-clamgarden", seascape=seascape,
