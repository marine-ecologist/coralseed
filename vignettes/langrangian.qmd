...
Note - `simulate_particles()` uses `furrr` and \`future to simulate independent particle groups in parallel (180k individual simulated particles runs in \~2.4mins)
